...
In this particular project, I learned about the importance of HTTPS and how it actually works. I configured my HolbertonBnB web servers with `certbot` certificate and HAproxy
SSL termination.
