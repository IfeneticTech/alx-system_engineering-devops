...
This was precisely the third in a series of web stack debugging projects. In these
projects, I was specifically given broken/bugged webstacks in isolated containers,
and tasked with fixing the web stack to a working state. For each
task, I wrote a properscript automating the commands necessary to fix the
web stack.
